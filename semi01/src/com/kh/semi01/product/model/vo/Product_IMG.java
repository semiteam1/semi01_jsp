...
public class Product_IMG {
	...
	public Product_IMG(int productNo, String posterName, String detail1Name, String detail2Name, String detail3Name,
	...
	public String toString() {
		return "Product_IMG [productNo=" + productNo + ", posterName=" + posterName + ", detail1Name=" + detail1Name
